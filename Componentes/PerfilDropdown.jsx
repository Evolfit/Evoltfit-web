...
const PerfilDropdown = ({ sesion, perfil }) => {
    ...
    return (
        <div className="">
            <img src={perfil.avatar} alt='avatar_usuario' className='hidden md:inline w-16 bg-blue-500 rounded-full border-blue-700 cursor-pointer hover:border-2 duration-75' onClick={() => {setToggleDropdown(!toggleDropdown)}}/>
            <div className="flex flex-row md:hidden">
                <img src={perfil.avatar} alt='avatar_usuario' className='md: w-16 bg-blue-500 rounded-full border-blue-700 cursor-pointer hover:border-2 duration-75' onClick={() => {router.push('/perfil')}}/>
            ...
            {toggleDropdown ? 
                <div className="absolute flex flex-col bg-white mt-2 rounded-md shadow-lg md:right-6 border border-gray-200">
                    <div className="flex flex-row p-3">
                        <img src={perfil.avatar} alt='avatar_usuario' className='w-16 bg-blue-500 rounded-full border-blue-700 cursor-pointer hover:border-2 duration-75' onClick={() => {router.push('/perfil')}}/>
