                ...
                <div className="my-6 border border-gray-300 rounded-lg w-9/12">
                    ...
                    <div className="flex flex-row px-4 py-3 border-t border-gray-300">
                        <div className="w-full">
                            ...
                            <p className="text-base font-normal">Cambiar contraseña</p>
                        </div>
                        <div className="w-fit my-auto">
                            <button className="btn btn-sm">Editar</button>
                        </div>
                ...
                <div className="flex flex-row justify-start items-center w-9/12">
                    {toggleEdit ? 
                        <div className="flex flex-col lg:flex-row w-full">
                            <button className="btn border-none bg-green-600 hover:bg-green-500 m-1">Guardar Cambios</button>
                            <button className="btn border-none bg-red-600 hover:bg-red-500 m-1">Cancelar</button>
                        </div>
                    :
