...
export default function VisualizadorProgreso() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setNum(Math.floor(Math.random() * (70 - 60 + 1)) + 60);
    }, 1300);
              ...
              <div className="body-map2 w-9/12" id="body-map2">
                <div id="male-body-maps" className="body-map__container2">
                  <div className="body-map__body2">
                    ...
                    >
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${abdomen}, ${Math.round(80 + ((abdomen / 255) * (255 - 80)))}, 255)` }}
                        id="Abdomen"
                      >
                        <path
                      ...
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${biceps}, ${Math.round(80 + ((biceps / 255) * (255 - 80)))}, 255)` }} id="Biceps">
                        <path
                      ...
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${hombros}, ${Math.round(80 + ((hombros / 255) * (255 - 80)))}, 255)` }} id="Hombros">
                        <path
                      ...
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${trapecio}, ${Math.round(80 + ((trapecio / 255) * (255 - 80)))}, 255)` }} id="Trapecio">
                        <path
                      ...
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${pecho}, ${Math.round(80 + ((pecho / 255) * (255 - 80)))}, 255)` }} id="Pecho">
                        <path
                      ...
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${cuadriceps}, ${Math.round(80 + ((cuadriceps / 255) * (255 - 80)))}, 255)` }} id="Cuadriceps">
                        <path
                      ...
                      <g className={"body-map__muscle2"} style={{ color: `rgb(${pantorrillas}, ${Math.round(80 + ((pantorrillas / 255) * (255 - 80)))}, 255)` }} id="Pantorrillas">
                        <path
                  ...
                  <div className="body-map__body2">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g id="Isquiotibiales" className={"body-map__muscle2"} style={{ color: `rgb(${isquiotibiales}, ${Math.round(80 + ((isquiotibiales / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Espalda Baja" className={"body-map__muscle2"} style={{ color: `rgb(${espaldaBaja}, ${Math.round(80 + ((espaldaBaja / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Gluteos" className={"body-map__muscle2"} style={{ color: `rgb(${gluteos}, ${Math.round(80 + ((gluteos / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Trapecio Medio" className={"body-map__muscle2"} style={{ color: `rgb(${trapecio}, ${Math.round(80 + ((trapecio / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Trapecio" className={"body-map__muscle2"} style={{ color: `rgb(${trapecio}, ${Math.round(80 + ((trapecio / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Hombros" className={"body-map__muscle2"} style={{ color: `rgb(${hombros}, ${Math.round(80 + ((hombros / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Pantorrillas" className={"body-map__muscle2"} style={{ color: `rgb(${pantorrillas}, ${Math.round(80 + ((pantorrillas / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <g id="Triceps" className={"body-map__muscle2"} style={{ color: `rgb(${triceps}, ${Math.round(80 + ((triceps / 255) * (255 - 80)))}, 255)` }}>
                        <path
                      ...
                      <svg>
                        <g id="Antebrazos" className={"body-map__muscle2"} style={{ color: `rgb(${antebrazos}, ${Math.round(80 + ((antebrazos / 255) * (255 - 80)))}, 255)` }}>
                          <path
