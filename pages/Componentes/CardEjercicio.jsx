  ...
  return (
    <div className="w-full p-6 bg-white border border-gray-200 rounded-lg shadow-md my-2">
        ...
        <div>
            ...
            <br/>
            <button onClick={() => {}} className="inline-flex items-center my-2 mx-1 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Hacer algo
